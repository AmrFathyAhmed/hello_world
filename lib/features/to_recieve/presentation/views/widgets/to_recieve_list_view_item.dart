...
class ToRecieveListViewItem extends StatelessWidget {
  const ToRecieveListViewItem({Key? key, this.onTap, this.isDelivered=false}) : super(key: key);
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Packed",style: Styles.styleBoldLeagueSpartan18,),
                          GestureDetector(
                            onTap: onTap,
                            child: Container(
                              decoration:BoxDecoration(
                      ...
                      child: Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Text("Delivered",style: Styles.styleMediumLeagueSpartan18),
