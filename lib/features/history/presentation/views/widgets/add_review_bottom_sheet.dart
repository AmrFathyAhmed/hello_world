...
import 'package:kendaka_app/features/history/presentation/views/widgets/review_dialog.dart';
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.only(top: 23,bottom: 43,),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                fillColor: Color(0xffF1F4FE), // Background color of the TextField
